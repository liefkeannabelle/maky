...
## Design Changes
- Updates to the feed page - Since last week, we have revamped the basic social interface and allowed users to select between viewing their friends posts or their own.

## Issues
- Ongoing database problems - On Sunday, the database once again seemed to clear, though significant portions of the data were left behind.
